...
export function Appointments() {
  ...
  return (
    <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <form className="mt-8 bg-white border rounded-lg p-6 space-y-4 shadow-sm" onSubmit={(e) => { e.preventDefault(); if (date && doctorId && patientId) addAppointment({ datetime: date, doctorId, patientId, notes }) }}>
        <div>
        ...
        <button type="submit" className="px-4 py-2 bg-gray-800 hover:bg-gray-900 text-white rounded-md shadow transition">Confirm</button>
      </form>
    </section>
  )
}
