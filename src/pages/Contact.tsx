export function Contact() {
  return (
    <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <form className="mt-6 bg-white border rounded-lg p-6 space-y-4">
        ...
        <button type="button" className="px-4 py-2 bg-gray-800 hover:bg-gray-900 text-white rounded-md transition">Send</button>
      </form>
    </section>
  )
}
