...
export function Patients() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="page-patients mt-8 grid md:grid-cols-2 gap-6">
        <form className="card bg-white border rounded-lg p-6 space-y-4 shadow-sm" onSubmit={(e) => { e.preventDefault(); handleSave() }}>
          ...
          <button type="submit" className="px-4 py-2 bg-brand text-white rounded-md shadow hover:shadow-md transition">Save</button>
        </form>
        <div className="card bg-white border rounded-lg p-6 shadow-sm">
